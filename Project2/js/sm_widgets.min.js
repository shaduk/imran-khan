...
var k=null,n=null;"undefined"!==typeof b.query.results&&0<b.query.count?(k=b.query.results[Object.keys(b.query.results)[0]],"feed"==a?(n=p(y[a],k),w(z[a],n)):"yahoo.finance.quotes"==a||"yahoo.finance.xchange"==a?(n=p(y[a],k),m(z[a],n)):"html"==a&&(n=u(d,k),m(z[a],n)),g(a,n)):g("smYqlQuerySuccess, no data for "+a,b)}function e(b,a,d){g("smYqlQueryError",a+"|"+d)}function g(b,a){E&&("undefined"!==typeof a?console.log(b,a):console.log(b))}c(document).ready(function(){var b=[],a=[],d=[],k=[],n=[];c(".sm-sortable-table").tablesort();
